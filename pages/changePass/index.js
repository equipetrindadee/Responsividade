        ...
        <body>
            <div>
                <div class="container-fluid p-0">
                    <div class="row m-0">
                        <div class="col-md-6 col-md-6-mudarSenha d-flex align-items-center justify-content-center flex-column order-md-1 order-2 ">
                            <img className="fundo-img" src="../img/img_mudarSenha.svg" alt="Image" class="img-fluid" />
                        </div>
                        <div class="col-md-6 bg-yellow  d-flex flex-column order-md-2 order-1 direito">
                            ...
                            <form className="changePassword-dad" onSubmit={formSubmitted ? handlePasswordReset : handleRecoverPassword}>
                                ...
                                <div class="mb-3 mb-3-senha email">
                                    <input className="form-control1" type="text" name="email" placeholder="Digite seu e-mail" value={email} onChange={(e) => setEmail(e.target.value)} /><br />
                                </div>
                                {/* password */}
                                <div class="mb-3 mb-3-senha senha">
                                    <input type="password" className="form-control2" name="newPassword" placeholder="Nova senha" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} />
                                </div>
                                {/* comfirmar password */}
                                <div class="mb-3 mb-3-senha comfirme">
                                    <input type="password" className="form-control3" name="confirmNewPassword" placeholder="Confirme a Nova senha" value={confirmNewPassword} onChange={(e) => setConfirmNewPassword(e.target.value)} />
                                </div>
