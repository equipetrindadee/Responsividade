    ...
    <div>
            ...
            <div className="d-lg-flex align-items-center">
              ...
              <div className="dropdown d-none d-lg-block">
                <button
                  ...
                  aria-expanded="false"
                >
                  <img src="../img/perfil-alerta.png" alt="User Icon" />
      ...
      <div className="container alert-container" >
        <div className="row">
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert1">
                ...
                <p>A simple danger check it out!</p>
              </div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert2">
                <i class='bx bx-error'></i>
                <p>A simple danger check it out!</p>
              </div>
            </div>
          ...
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert3">
                <i class='bx bx-error'></i>
                <p>A simple danger check it out!</p>
              </div>
            </div>
          ...
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert4">
                <i class='bx bx-error'></i>
                <p>A simple danger check it out!</p>
              </div>
            </div>
        ...
        <div className="row">
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert5">
                <i class='bx bxs-radiation' ></i>
                <p>A simple warning check it out!</p>
          ...
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert6">
                <i class='bx bxs-radiation' ></i>
                <p>A simple warning check it out!</p>
              </div>
            </div>
          ...
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert7">
                <i class='bx bxs-radiation' ></i>
                <p>A simple warning check it out!</p>
              </div>
            </div>
          ...
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert8">
                <i class='bx bxs-radiation' ></i>
        ...
        <div className="row">
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert9">
                <i class='bx bx-check-circle'></i>
                <p>A simple success check it out!</p>
              </div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert10">
                <i class='bx bx-check-circle'></i>
                <p>A simple success check it out!</p>
              </div>
            </div>
          ...
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert11">
                <i class='bx bx-check-circle'></i>
                <p>A simple success check it out!</p>
              </div>
            </div>
          ...
          <div className="col-md-3">
            <div className="alert-box">
              <div className="color-box alert12">
                <i class='bx bx-check-circle'></i>
                <p>A simple success check it out!</p>
              </div>
            </div>
